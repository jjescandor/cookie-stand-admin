    ...
    return (
        <div className="bg-emerald-50 text-black items-center h-screen content-center items-center">
            ...
            <main className='flex flex-col items-center h-5/6'>
                ...
                {input?.length > 0 &&
                    <div className="flex">
                        <button onClick={clearData} className='flex flex-row p-4 bg-emerald-700 rounded-md shadow-lg hover:bg-red-200 m-1'> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="my-auto mx-3 w-6 h-6">
